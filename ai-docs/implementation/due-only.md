...
- [ ] Step 4a — Global "Study due" button on `/stats`
- [ ] Step 4b — Per-level "Study due" button on `/stats` (and/or `/learn/[level]`, TBD)
- [ ] Step 4c — Clickable due badges in `LevelStatRows.svelte`
