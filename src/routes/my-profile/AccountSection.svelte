...
>
  <h2 class="mb-5 text-base font-semibold text-gray-800 dark:text-gray-100">Account</h2>
  ...
  <div class="mb-6 flex items-center gap-4">
    ...
    <p class="text-sm text-gray-500 dark:text-gray-400">Avatar upload coming soon.</p>
  </div>
  ...
  >
    ...
    <div>
      ...
      <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
        Managed via your sign-in link — not editable here.
      </p>
    </div>
  ...
  <div class="mt-6 border-t border-gray-100 pt-5 dark:border-gray-700">
    <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
      <div>
        <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Export my data</p>
        <p class="text-xs text-gray-500 dark:text-gray-400">
          Download all your card progress as a JSON file.
        </p>
      </div>
      <button
        type="button"
