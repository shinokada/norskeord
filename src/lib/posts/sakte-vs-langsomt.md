...
Begge ord betyr "slowly" på engelsk, men de brukes litt forskjellig:
...
**Langsom** er adjektivet; **langsomt** er adverbet:

| Form         | Bruk                               | Eksempel              |
| ------------ | ---------------------------------- | --------------------- |
| **langsom**  | adjektiv (beskriver et substantiv) | en langsom bil        |
| **langsomt** | adverb (beskriver en handling)     | bilen kjører langsomt |

**Sakte** kan brukes som begge, men er vanligst som adverb:

| Form           | Bruk                                | Eksempel        |
| -------------- | ----------------------------------- | --------------- |
| **sakt/sakte** | adjektiv (uvanlig, litt gammeldags) | et sakte tog    |
| **sakte**      | adverb (vanlig)                     | toget går sakte |

I praksis bruker man **langsom** som adjektiv og **sakte** som adverb i dagligtale.
...
Som en tommelfingerregel: **sakte** i samtale, **langsomt** i skrift.
...
- **langsomt** → litt mer formelt, vanlig i skrift og litteratur
- **langsom** → adjektivformen (en langsom bil)
- Komparativ: **saktere** / **langsommere**
- Usikker? Velg **sakte** i muntlig norsk

---

## Vanlige uttrykk

snakk sakte · gå sakte · saktere · det går sakte · en langsom prosess · tiden gikk langsomt
