...
| Fram-form       | Frem-form       | Anbefalt i skriving |
| --------------- | --------------- | ------------------- |
| framme          | fremme          | **fremme**          |
| framover        | fremover        | **fremover**        |
...
- **Fram** og **frem** betyr det samme
- **Frem** er mer standard i skriftlig norsk
- I tale hører du begge — særlig **fram** er svært vanlig
- Fastuttrykkene **fremme** og **fremover** dominerer i skriving

---

## Relaterte ord

fremme · fremover · frem til · bakover · tilbake · finne fram

---

_→ Lurer du på uttrykket **finne fram**? Les: [Finne fram — take out / bring out](/blog/finner-fram)_
